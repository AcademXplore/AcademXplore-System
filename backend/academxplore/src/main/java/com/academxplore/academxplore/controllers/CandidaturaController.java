...
public class CandidaturaController {
    ...
    public ResponseEntity<Object> buscarCandidaturasDoUsuario(@PathVariable("id") String id){
        try{
            return ResponseEntity.ok().body(candidaturaService.buscarCandidaturasDoUsuario(id));
        }
        catch(Exception e){
            return ResponseEntity.internalServerError().body(e.getMessage());
        }
